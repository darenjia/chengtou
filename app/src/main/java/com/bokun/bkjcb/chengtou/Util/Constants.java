...
//    public static final String GET_TABLT_DATA_URL = "http://192.168.100.123:8081/JBPM/phone/huibiantongji?biaoming=";
    ...
    public static final String IP_1 = "192.168.100.211";
    public static final String IP_2 = "192.168.34.240";
    public static final String IP_3 = "192.168.100.123";
    public static String HTTP_URL = HTTPURL.replace("IP_ADDRESS", IP_1);
    public static String HTTP_DERAIL_URL = GET_DETAIL_URL.replace("IP_ADDRESS", IP_3);
    public static String HTTP_TABLE_URL = GET_TABLT_DATA_URL.replace("IP_ADDRESS", IP_3);
}
